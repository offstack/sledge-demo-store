...
import {FetcherWithComponents, useFetcher, useMatches} from '@remix-run/react';
    ...
    >
      {(fetcher: FetcherWithComponents<any>) => {
        return (
          <div
            className={`${
              variant === 'icon' ? 'flex gap-[8px] mt-[32px]' : ''
            }`}
          >
