...
function root({
  ...
  return {
    title: shop?.name,
    titleTemplate: '%s | Sledge Demo Store',
...
function home(): SeoConfig<WebPage> {
  return {
    title: 'Home',
    titleTemplate: 'Sledge Demo Store',
    description: 'Sledge Demo Store',
    robots: {
      noIndex: false,
      noFollow: false,
    },
...
function blogIndex(): SeoConfig<WebPage> {
  return {
    title: 'Blog',
    titleTemplate: 'Blog | Sledge Demo Store',
    description: 'Sledge Blog',
    robots: {
      noIndex: false,
      noFollow: false,
    },
