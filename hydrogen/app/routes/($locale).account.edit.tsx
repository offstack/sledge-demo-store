...
export default function AccountDetailsEdit() {
  ...
  return (
    <>
      <h3 className="mt-4 mb-6">Update your profile</h3>
      <fetcher.Form method="post">
        {fetcher.data?.formError && (
          <div className="flex items-center justify-center mb-6 bg-red-100 rounded">
            <p className="m-4 text-sm text-red-900">{fetcher.data.formError}</p>
          </div>
        )}
        <div className="mt-3">
          <input
        ...
        <h3 className="mb-6 mt-6">Change your password</h3>
        <Password
        ...
        <div className="flex flex-wrap gap-3 items-center mt-5">
          ...
          <div>
            <Button text="Cancel" to=".." isArrow={false}></Button>
          </div>
        </div>
      </fetcher.Form>
    </>
