  ...
  return (
    <div className="flex justify-center my-24 px-4">
      <div className="max-w-md w-full">
        ...
        <p className="mt-4 max-w-[594px] font-inter font-medium text-[12px] md:text-[16px] leading-[25.6px] tracking-[-0.32px] text-dark4">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <Button text="Reset Password" isArrow={false} type={'submit'} />
          </div>
        </Form>
      </div>
    </div>
